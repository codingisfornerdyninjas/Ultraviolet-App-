...
location.href = "https://npsd.schoology.com/home#/?_k=rim4k6"
  }
})


var x_ = document.createElement("h1");
x_.innerHTML = moment().format("LTS");
x_.style.color = "white";
x_.style.textAlign = "center";

setInterval(function(){
  x_.innerHTML = moment().format("LTS");
  document.body.appendChild(x_)
    ...
    <link rel="shortcut icon" content="ss-removebg-preview.png" />
  ...
  <body>
    ...
    >
      <img class="logo" src="chicken.jpeg" alt="Ultraviolet" />
